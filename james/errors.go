...
var (
	ErrMaxEmailLengthExceeded   = fmt.Errorf("email cannot contain more than %d characters", MaxEmailLength)
	ErrNilObjectIdentifierError = fmt.Errorf("nil object identifier")
)
